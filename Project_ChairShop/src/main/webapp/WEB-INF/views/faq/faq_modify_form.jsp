...
<script type="text/javascript">
	...
	function cancel(){
		...
		location.href="view.do?f_idx=${ vo.f_idx }&page=${ param.page }";
	}
	
	function send(f){
		
		var f_subject = f.f_subject.value.trim();
		...
		<form>
			...
			<div class="content_f">
				...
				<table class="table">
		      		<tr>
						<th width="20%">제목</th>
						<td width="80%"><input name="f_subject" type="text" style="width: 85%; height: 30px;" value="${ vo.f_subject }"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td>
							<textarea name="f_content">${ vo.f_content }</textarea>
						</td>
					</tr>
					<tr>
